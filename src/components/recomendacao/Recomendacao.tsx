...
export function Recommendacao({ recomendacoes, onClose }: RecommendationsSectionProps) {
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-12 relative">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-6">
                        Selecionamos as melhores opções com menos calorias de cada categoria para você!
                    </p>
                    ...
                    <Card className="inline-block bg-emerald-50 border-emerald-200">
                        <CardContent className="p-6">
                            <div className="flex items-center gap-3 text-emerald-800">
                                ...
                                <p className="text-sm">
                                    <strong>Dica:</strong> As recomendações são baseadas nas opções com menor quantidade de calorias em cada categoria,
                        ...
                        <div key={categoria.categoriaId}>
                            ...
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-2xl font-bold text-gray-900">{categoria.categoriaNome}</h3>
                                </div>
                                <div className="flex-1 h-px bg-gray-200"></div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {categoria.encomendas.map((encomenda, index) => (
                                    <Card
                                        key={encomenda.id}
                                        className={`overflow-hidden hover:shadow-lg transition-all group ${index === 0 ? 'border-2 border-emerald-500' : ''
                                            }`}
                                    >
                                        ...
                                        <CardContent className="p-5">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <p className="text-2xl font-bold text-emerald-600">
                                                    R$ {encomenda.preco ? Number(encomenda.preco).toFixed(2) : "0,00"}
                                                </p>
                                                <Button
                                            ...
                                            {index === 0 && (
                                                <div className="mt-4 p-2 bg-gradient-to-r from-yellow-50 to-emerald-50 rounded-lg text-center">
