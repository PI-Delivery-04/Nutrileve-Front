...
const team = [
  {
    name: "Beatriz M. Vieira",
    role: "Desenvolvedora Full Stack",
    description: "Responsável pelo desenvolvimento e manutenção do aplicativo.",
    image:
      "https://media.licdn.com/dms/image/v2/D4E03AQHnIB3UBtREBQ/profile-displayphoto-crop_800_800/B4EZrgP6LkHUAQ-/0/1764698860115?e=1771459200&v=beta&t=Muti7eqXycSKTcDGRn_piEW3uFiliKGUaLsSTMJS-pE",
  ...
  },
  {
    ...
    description: "Responsável pelo desenvolvimento e manutenção do aplicativo.",
    image:
      "https://media.licdn.com/dms/image/v2/D4D03AQHMl1sB038zAQ/profile-displayphoto-crop_800_800/B4DZvsP3BEJgAQ-/0/1769195139672?e=1771459200&v=beta&t=3XB-PjGIAFHGQ2p59s-Fm2dxrku-Hwsk5OCtCghh6oc",
  ...
  },
  {
    ...
    description: "Responsável pelo desenvolvimento e manutenção do aplicativo.",
    image:
      "https://media.licdn.com/dms/image/v2/D4D03AQHqJAhp6Vzjyw/profile-displayphoto-scale_400_400/B4DZq4Gr91GwAo-/0/1764025352811?e=1771459200&v=beta&t=TtyQUJLbOG8Xu5qOBywljQD_DSCfnA378xUoon1CeZs",
  ...
  },
  {
    ...
    role: "Product Owner",
    description:
      "Responsável pela definição de requisitos e priorização das funcionalidades do aplicativo.",
    image:
      "https://media.licdn.com/dms/image/v2/D4D03AQF24dFzoWyGHA/profile-displayphoto-crop_800_800/B4DZrhBL7sJMAI-/0/1764711776590?e=1771459200&v=beta&t=Th_z-0CZYqyO85RYtJ4q26lN9s25Pk9uWg8wXYrkR7A",
  ...
  },
  {
    ...
    image:
      "https://media.licdn.com/dms/image/v2/D4D03AQH7c46FznC5dw/profile-displayphoto-shrink_800_800/B4DZdami_yG8Ac-/0/1749571751681?e=1771459200&v=beta&t=7Qoo82PfwW94MtrKPac_eb0l4mC-dk171bzXqrHJyLg",
  ...
  },
  {
    ...
    image:
      "https://media.licdn.com/dms/image/v2/D4D03AQF_8MAQdsniqg/profile-displayphoto-crop_800_800/B4DZq9BYJ1IAAI-/0/1764107847051?e=1771459200&v=beta&t=f47XM8cNz0ILPju-1AGOd5-GLORjKfEvuOR9dqDFHq0",
  ...
  },
  {
    ...
    description: "Responsável pelo desenvolvimento e manutenção do aplicativo.",
    image:
      "https://media.licdn.com/dms/image/v2/D4D03AQETTpGVdigF2Q/profile-displayphoto-crop_800_800/B4DZor2a1BJEAI-/0/1761672277759?e=1771459200&v=beta&t=O_Jghe6ukGrujnMpnnqNiE_3XZKpooWaAmOwgtxcYyM",
    ...
    >
      ...
      <div className="text-center mt-16 mb-16">
        ...
        <p className="text-lg text-gray-600 max-w-4xl mx-auto mb-12">
          O NutriLeve é uma plataforma de delivery inteligente que conecta
          pessoas a restaurantes parceiros especializados em alimentação
          saudável, unindo tecnologia, praticidade e bem-estar em uma única
          experiência.
        </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition">
            <h3 className="text-xl font-semibold text-black mb-3">🌱 Missão</h3>
          ...
          {/* VISÃO */}
          <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg transition">
            <h3 className="text-xl font-semibold text-black mb-3">🌱 Visão</h3>
