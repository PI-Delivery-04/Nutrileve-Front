        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex justify-between items-start gap-2 mb-1">
            ...
            <button
              ...
              className="text-red-500 hover:text-red-700 p-1 -mt-1 hover:cursor-pointer"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 bg-gray-100 rounded-lg p-1">
              ...
              >
                <Minus className="w-4 h-4 hover:cursor-pointer" />
              </button>
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-1 text-xs text-gray-600 hover:bg-gray-100 rounded hover:cursor-pointer"
              >
                Cancelar
              </button>
              <button
                onClick={handleSaveObservations}
                className="px-3 py-1 text-xs bg-emerald-600 text-white rounded hover:bg-green-600 hover:cursor-pointer"
              >
                Salvar
              </button>
            </div>
