...
export const CartDrawer = ({ isOpen, onClose }: CartDrawerProps) => {
  ...
  return (
    <>
      ...
      >
        {/* Header do Drawer */}
        <div className="flex items-center justify-between p-4 border-b bg-linear-to-r bg-emerald-100 text-emerald-700">
          ...
          <div className="border-t bg-gray-50 p-4 space-y-3">
            ...
            <button
              ...
              className="w-full bg-linear-to-r from-emerald-500 to-emerald-600 text-white 
                       ...
                       shadow-lg hover:shadow-xl hover:cursor-pointer"
            >
              Finalizar Pedido
            </button>
